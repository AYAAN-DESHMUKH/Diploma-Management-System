...
class QB:
    ...
    def __init__(self, master):
        ...
        select_button = tk.Button(master, text="Select PDF", command=self.on_select_pdf, bg='green', fg='white',
                                  font=('Arial', 24))
        ...
        modal_button = tk.Button(master, text="Modal Answer Paper", command=explore_modal_paper, bg='yellow' ,fg='black',
                                 font=('Arial', 18))
        modal_button.place(relx=0.2, rely=0.5, anchor=tk.CENTER)

        question_button = tk.Button(master, text="Question Papers", command=hello, bg='blue', fg='white',
                                    font=('Arial', 18))
        ...
        ques= ttk.Label(self.master, text="Explore Official MSBTE Question Papers", font=('Arial', 14), background='black',
                                foreground='white')
        ques.place(x=915,y=430)
